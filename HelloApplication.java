...
import com.example.lab_1_java.figures.*;
...
// Список фигур для отрисовки дома
        ...
        createAndAddCarShapes();https://codelab.tpu.ru/veb13/java-2-lab-1.git
        saveShapesToFile(carShapes, notHouseFile);
        createAndAddOvalFamily();
        saveShapesToFile(ovalFamily, ovalFile);
    ...
    private void createAndAddOvalFamily(){
        ovalFamily.add(new Oval(50.0, 50.0, 100.0, 10.0, 0.0));
        ovalFamily.add(new Oval(50.0, 50.0, 100.0, 10.0, 45.0));
    }
